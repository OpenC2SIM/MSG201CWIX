...
- Server 4.8.4.1 war file beta bug fixes for C2SIM controls + implements standard iitialization or automatic initialization (for use with late join only) [link](https://github.com/OpenC2SIM/https---github.com-OpenC2SIM-MSG201CWIX/blob/master/C2SIMServer%23%234.8.4.1.war)
